...
http.createServer((req,res)=>{
 ...
 if(['/portal-home.js','/portal-home.css','/hours-history.css','/class-checkout.css','/enrollment-grades.css'].includes(url.pathname)){res.setHeader('Content-Type',url.pathname.endsWith('.js')?'text/javascript':'text/css');return res.end(fs.readFileSync(path.join(root,url.pathname)));}
 ...
 </script><script src="/portal-home.js"></script><script>renderPortalHome()</script>`;
